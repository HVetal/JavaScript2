    ...
    <header class="header">
        <div class="container header__wrp">
            <div class="header__wrp-controls">
                <router-link to="/"><img class="header__logo" src="../img/logo.svg" alt="logo"></router-link>
    ...
    <main class='container'>
        <section class="product_path">
            ...
            <div class="product_path__wrp container">
                <p class="product_path__wrp-title">SHOPPING CART</p>
            </div>
        </section>
        <section class="product_card_in_cart">
            <div class="product_card">
               <cartlist></cartlist>
            </div>
            <div class="product_card_shipping_adress">
                <form class="product_card_shipping_adress-form" action="">
                    <input type="text">
                    <input type="text">
                    <input type="text">
