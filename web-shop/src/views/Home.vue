<template>
  <div class="home">
        ...
        <div class="container header__wrp">
            ...
            <div class="header__wrp-controls">
                ...
                <a class="header__link" href="registration.html"><svg class="header__link-person" width="29" height="29"
                    ...
                    <router-link to="/cart">
                <svg class="header__link-basket" width="33" height="29"
    ...
    <main>
      ...
      <cart v-if="isCartVisible" :list="cart" v-on:removefromcart="onRemoveFromCart" v-on:cart-close="onCartOpen"></cart>
...
import sort from '../components/filter.vue'
